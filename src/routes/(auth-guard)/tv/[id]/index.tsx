		...
		<Resource
			...
			onResolved={(value) => (
				<div
					...
					style={`background: url(https://image.tmdb.org/t/p/original${value.tv.backdrop_path});background-size: cover;background-attachment: fixed;background-position: center; background-repeat: no-repeat;`}
				>

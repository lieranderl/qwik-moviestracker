...
ARG VITE_TMDB_API_KEY $_VITE_TMDB_API_KEY
ARG VITE_GC_API_KEY $_VITE_GC_API_KEY
ARG VITE_FIREBASE_CONFIG $VITE_FIREBASE_CONFIG
ARG AUTH_SECRET $AUTH_SECRET
ARG GOOGLE_SECRET $GOOGLE_SECRET
ARG GOOGLE_ID 695761327713-fmfiitn3og9cgd76dhogaupqtm8n23v5.apps.googleusercontent.com

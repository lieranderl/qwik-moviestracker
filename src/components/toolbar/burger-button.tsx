  ...
  return (
    <details class="dropdown dropdown-end dropdown-bottom md:hidden">
      <summary
        ...
        class="btn btn-ghost btn-circle text-base-content/80 min-h-11 w-11 list-none p-0"
      >
        <HiBars3Solid aria-hidden="true" class="text-2xl" />
      </summary>
      <ul
        role="menu"
        class="menu menu-sm dropdown-content bg-base-100 border-base-200 rounded-box z-[60] mt-3 w-60 border p-2 shadow-xl"
      >
        <Slot />
      </ul>
    </details>
